...
export const Cookies = () => {
  return (
    <div className="max-h-96 overflow-y-scroll mt-4">
      <p>
        This is the Cookie Policy for BLAG, accessible from{' '}
        <a
          href="https://blag.adrielgama.dev/"
          target="_blank"
      ...
      <h3 className="my-2 font-bold">What Are Cookies</h3>
      ...
      <h3 className="my-2 font-bold">How We Use Cookies</h3>
      ...
      <h3 className="my-2 font-bold">Disabling Cookies</h3>
      ...
      <h3 className="my-2 font-bold">The Cookies We Set</h3>
      ...
      <ul>
        ...
        <li>
          <h3 className="my-2 font-semibold">Login related cookies</h3>
          <p>
        ...
        <li>
          <h3 className="my-2 font-semibold">Forms related cookies</h3>
          <p>
        ...
        <li>
          <h3 className="my-2 font-semibold">Site preferences cookies</h3>
          <p>
      ...
      <h3 className="my-2 font-bold">Third Party Cookies</h3>
      ...
      <h3 className="my-2 font-bold">More Information</h3>
